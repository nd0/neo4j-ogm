...
public class DefaultEntityAccessStrategyTest {
    ...
    public void shouldRetrieveObjectAccessForWritingIterableObject() {
        ...
        EntityAccess iterableAccess = this.entityAccessStrategy.getIterableWriter(classInfo, Satellite.class, "satellites", Relationship.OUTGOING);
    ...
    public void shouldNotRetrieveSetterMethodObjectAccessIfTypesAreIncompatible() {
        ...
        EntityAccess objectAccess = this.entityAccessStrategy.getRelationalWriter(classInfo, "SATELLITES", Relationship.OUTGOING, singleSatellite);
    ...
    public void shouldPreferAnnotatedMethodToAnnotatedFieldWhenSettingRelationshipObject() {
        ...
        EntityAccess objectAccess = this.entityAccessStrategy.getRelationalWriter(classInfo, "HAS_ACTIVITY", Relationship.OUTGOING, new Comment());
        assertNotNull("The resultant object accessor shouldn't be null", objectAccess);
    ...
    public void shouldPreferAnnotatedFieldToPlainSetterMatchingRelationshipTypeWhenSettingRelationshipObject() {
        ...
        EntityAccess objectAccess = this.entityAccessStrategy.getRelationalWriter(classInfo, "CONTAINS", Relationship.OUTGOING, parameter);
        assertNotNull("The resultant object accessor shouldn't be null", objectAccess);
        DummyDomainObject domainObject = new DummyDomainObject();
    ...
    public void shouldPreferSetterBasedOnRelationshipTypeToFieldInObjectWithoutAnnotations() {
        ...
        EntityAccess objectAccess = this.entityAccessStrategy.getRelationalWriter(classInfo, "LOCATION", Relationship.OUTGOING, satelliteLocation);
        assertNotNull("The resultant object accessor shouldn't be null", objectAccess);
        assertTrue("The access mechanism should be via the setter", objectAccess instanceof MethodWriter);
    ...
    public void shouldPreferFieldBasedOnRelationshipTypeToPlainSetterWithMatchingParameterType() {
        ...
        EntityAccess objectAccess = this.entityAccessStrategy.getRelationalWriter(classInfo, "FAVOURITE_TOPIC", Relationship.OUTGOING, favouriteTopic);
        assertNotNull("The resultant object accessor shouldn't be null", objectAccess);
        DummyDomainObject domainObject = new DummyDomainObject();
    ...
    public void shouldDefaultToFindingSetterThatMatchesTheParameterTypeIfRelationshipTypeCannotBeMatched() {
        ...
        EntityAccess objectAccess = this.entityAccessStrategy.getRelationalWriter(classInfo, "DOES_NOT_MATCH", Relationship.OUTGOING, favouriteTopic);
        assertNotNull("The resultant object accessor shouldn't be null", objectAccess);
        DummyDomainObject domainObject = new DummyDomainObject();
        objectAccess.write(domainObject, favouriteTopic);
        assertEquals(domainObject.favouriteTopic, favouriteTopic);
    ...
    public void shouldDefaultToFieldThatMatchesTheParameterTypeIfRelationshipTypeCannotBeMatchedAndNoSetterExists() {
        ...
        EntityAccess objectAccess = this.entityAccessStrategy.getRelationalWriter(classInfo, "UTTER_RUBBISH", Relationship.OUTGOING, forumPost);
        assertNotNull("The resultant object accessor shouldn't be null", objectAccess);
        DummyDomainObject domainObject = new DummyDomainObject();
    ...
    public void shouldPreferAnnotatedFieldWithMatchingRelationshipTypeWhenGettingIterableWriter() {
        ...
        EntityAccess objectAccess = this.entityAccessStrategy.getIterableWriter(classInfo, Satellite.class, "NATURAL", Relationship.OUTGOING);
        assertNotNull("The resultant object accessor shouldn't be null", objectAccess);
        DummyDomainObject domainObject = new DummyDomainObject();
